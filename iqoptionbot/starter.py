...
def start():
    ...
    signalers = starter.start_signalers(["EURUSD"])
    traders = starter.start_traders(["EURUSD"])
        ...
        for signaler in signalers:
            ...
            if signal:
                ...
                for trader in traders:
                    logger.info("======================");
                    logger.info(signal.price);
                     
                    logger.info(signal.active);
                    logger.info(signal.option);
                    logger.info(signal.direction);
                    logger.info(api_constants.ACTIVES["EURUSD"]);
                    logger.info("======================");
